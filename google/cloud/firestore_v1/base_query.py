...
class BaseQuery(object):
    ...
    def order_by(self: QueryType, field_path: str, direction: str = ASCENDING) -> QueryType:
    ...
    def start_at(
        self: QueryType, document_fields_or_snapshot: Union[DocumentSnapshot, dict, list, tuple]
    ) -> QueryType:
